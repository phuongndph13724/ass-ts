                            ...
                            <div className="filter-sidebar-left">
                                ...
                                <div className="list-group list-group-collapse list-group-sm list-group-tree"
                                    ...
                                    <div className="list-group-collapse sub-men">
                                        <a className="list-group-item list-group-item-action" href="#sub-men1"
                                    ...
                                    <div className="list-group-collapse sub-men">
                                        <a className="list-group-item list-group-item-action" href="#sub-men2"
                                            data-toggle="collapse" aria-expanded="false" aria-controls="sub-men2">
                                            Footwear
                                            <small className="text-muted">(50)</small>
                                        </a>
                                                    ...
                                                    <div className="flex items-center justify-between pt-[2px]">
                                                        <div className="product-action d-flex justify-content-around">
                                                            <a href="#like" data-toggle="tooltip" data-placement="top"
                                                                title="Yêu thích sản phẩm"><i
                                                                    className="fas fa-heart px-2" style={{color: 'red'
                                                                    }} /></a><span className="saperator">|</span>
                                                            <a href="#view" data-toggle="tooltip" data-placement="top"
                                                                title="Xem chi tiết"><i
                                                                    className="fas fa-eye px-2" /></a><span
                                                                className="saperator">|</span>

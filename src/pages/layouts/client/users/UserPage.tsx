  ...
  return (
    <div>
        <div className="banner_content">
          <div className="d-flex m-[20px] p-[30px] bg-secondary bg-opacity-50">
              ...
              <div className="media-body">
                <div className="personal_text  text-left p-[20px]">
                    <h6 className='fs-1 my-[10px]' >Thông Tin Tài Khoản</h6>
                    ...
                    {/* <li className='p-2'><a href="#"><i className="lnr lnr-home" /> Santa monica bullevard</a></li> */}
                    </ul>
